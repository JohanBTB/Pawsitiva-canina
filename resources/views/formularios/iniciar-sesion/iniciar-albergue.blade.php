<section class="relative isolate px-6 pt-14 lg:px-8 bg-gris-50 relative isolate text-marron-500">
    <div class="mx-auto max-w-4xl py-32 sm:py-48 lg:py-48 max-w-screen-md">
        <h2 class="mb-4 text-6xl tracking-tight font-extrabold text-center text-marron-800">Iniciar sesion: albergue  </h2>
        <form id="form-registro" method="POST" action="/iniciar-sesion?registro=albergue">
        @csrf
            ...
            <div class="text-align-center flex justify-center border-b border-gris-900/10 mt-24 pb-12">
                ...
                <div class="md:w-max[80%] w-[50%]  mt-10 text-medium md:text-xl">
                    ...
                    <div class="block mt-16">
                        <button type="submit" class="rounded-md bg-marron-600 p-3 font-semibold text-base text-white shadow-sm hover:bg-marron-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-marron-600  w-full">Iniciar sesión</button>
                    </div>
                </div>
            </div>
        </form>
