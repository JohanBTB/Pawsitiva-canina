...
<section class="relative isolate px-6 mt-96  md:mt-40 xl:mt-12 bg-gris-50 relative isolate text-marron-500">
    <div class="mx-auto max-w-4xl py-12 md:py-24 xl:py-48 max-w-screen-md">
        <h2 class="mb-4 text-6xl tracking-tight font-extrabold text-center text-marron-800">Actualizar albergue  </h2>
        ...
        <div class="w-[80%] mx-auto space-y-12">
            <div class="border-b border-gris-900/10 mt-24 pb-12">
                ...
                <input type="hidden" name="registro" value="albergue">
                <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                    <div class="sm:col-span-2 sm:col-start-1">
                    <label for="nombre" class="block text-sm font-medium leading-6 text-marron-800">Nombre</label>
                    <div class="mt-2">
                        <input required type="text" value="{{$albergue['nombre']}}" name="nombre" id="nombre" autocomplete="off" class="block w-full rounded-md border-0 py-1.5 text-gris-900 shadow-sm ring-1 ring-inset ring-gris-300 placeholder:text-gris-400 focus:ring-2 focus:ring-inset focus:ring-marron-600 sm:text-sm sm:leading-6">
                    </div>
                </div>

                <div class="col-span-2">
                    <label for="direccion" class="block text-sm font-medium leading-6 text-marron-800">Direccion</label>
                    <div class="mt-2">
                        <input required type="text" value="{{$albergue['direccion']}}" name="direccion" id="direccion" autocomplete="family-name" class="block w-full rounded-md border-0 py-1.5 text-gris-900 shadow-sm ring-1 ring-inset ring-gris-300 placeholder:text-gris-400 focus:ring-2 focus:ring-inset focus:ring-marron-600 sm:text-sm sm:leading-6">
                    </div>
                </div>

                <div class="sm:col-span-2">
                    <label requiredfor="numero_telefonico" class="block text-sm font-medium leading-6 text-marron-800">Numero telefonico</label>
                    <div class="mt-2">
                        <input required type="text" value="{{$albergue['numero_telefonico']}}" pattern="[0-9]+" name="numero_telefonico" id="numero_telefonico" autocomplete="off" class="block w-full rounded-md border-0 py-1.5 text-gris-900 shadow-sm ring-1 ring-inset ring-gris-300 placeholder:text-gris-400 focus:ring-2 focus:ring-inset focus:ring-marron-600 sm:text-sm sm:leading-6">
                    </div>
                </div>

                <div class="sm:col-span-4">
                    <label for="correo" class="block text-sm font-medium leading-6 text-marron-800">Correo electrónico</label>
                    <div class="mt-2">
                        <input required id="correo" value="{{$albergue['correo']}}" name="correo" type="email" autocomplete="email" class="block w-full rounded-md border-0 py-1.5 text-gris-900 shadow-sm ring-1 ring-inset ring-gris-300 placeholder:text-gris-400 focus:ring-2 focus:ring-inset focus:ring-marron-600 sm:text-sm sm:leading-6">
                    </div>
                </div>
                ...
                <div class="col-span-full ml-[15%]">
                    ...
                    <div class="mt-2 w-64 h-64 flex relative justify-center items-center rounded-lg border border-dashed border-gris-900/25 px-6 py-10">
                        <div>
                            <img id="imgPrevisualizacion" class="absolute h-full w-full top-0 left-0 opacity-75 hover:opacity-25 rounded-xl " src="{{$albergue['foto']}}"/>
                        </div>
