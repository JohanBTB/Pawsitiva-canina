<section class="relative isolate px-6  mt-96  md:mt-40 xl:mt-12  bg-gris-50 relative isolate text-marron-500">
    <div class="mx-auto max-w-4xl py-12 md:py-24 xl:py-48 max-w-screen-md">
        <h2 class="mb-4 text-6xl tracking-tight font-extrabold text-center text-marron-800">Registrar Usuario</h2>
        ...
        <div class="w-[80%] mx-auto space-y-12">
            <div class="border-b border-gris-900/10 mt-24 pb-12">
                ...
                <input type="hidden" name="registro" value="usuarios">
                ...
                <div class="sm:col-span-3">
                    ...
                    <div class="mt-2">
                        <input required type="text" name="apellido" id="apellido" autocomplete="off" class="block w-full rounded-md border-0 py-1.5 text-gris-900 shadow-sm ring-1 ring-inset ring-gris-300 placeholder:text-gris-400 focus:ring-2 focus:ring-inset focus:ring-marron-600 sm:text-sm sm:leading-6">
                    </div>
                </div>
                ...
                <div class="sm:col-span-4">
                    ...
                    <div class="mt-2">
                        <input required id="correo" name="correo" type="email" autocomplete="email" class="block w-full rounded-md border-0 py-1.5 text-gris-900 shadow-sm ring-1 ring-inset ring-gris-300 placeholder:text-gris-400 focus:ring-2 focus:ring-inset focus:ring-marron-600 sm:text-sm sm:leading-6">
                    </div>
                </div>
                ...
                <div class="sm:col-span-2">
                    ...
                    <div class="mt-2">
                        <input required type="number" name="edad" id="edad" autocomplete="off" class="block w-full rounded-md border-0 py-1.5 text-gris-900 shadow-sm ring-1 ring-inset ring-gris-300 placeholder:text-gris-400 focus:ring-2 focus:ring-inset focus:ring-marron-600 sm:text-sm sm:leading-6">
                    </div>
                    </div>
                ...
                <div class="sm:col-span-2">
                    ...
                    <div class="mt-2">
                        <input required pattern="[0-9]+" type="text" name="numero_telefonico" id="numero_telefonico" autocomplete="off" class="block w-full rounded-md border-0 py-1.5 text-gris-900 shadow-sm ring-1 ring-inset ring-gris-300 placeholder:text-gris-400 focus:ring-2 focus:ring-inset focus:ring-marron-600 sm:text-sm sm:leading-6">
                    </div>
                </div>
        ...
        <div class="w-full mx-auto mt-6 flex items-center justify-end gap-x-6">
            ...
            <button type="submit" class="w-full rounded-md bg-marron-600 text-base p-3 text-sm font-semibold text-white shadow-sm hover:bg-marron-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-marron-600">Registrar</button>
        </div>
        </form>
    </div>
</section>