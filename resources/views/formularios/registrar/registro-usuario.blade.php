<section class="relative isolate px-6  mt-96  md:mt-40 xl:mt-12  bg-gris-50 relative isolate text-marron-500">
    <div class="mx-auto max-w-4xl py-12 md:py-24 xl:py-48 max-w-screen-md">
        ...
        <form id="form-registro" method="POST" action="{{ route('usuarios.store') }}" enctype="multipart/form-data">
            @csrf
        ...
        <div class="border-b border-gris-900/10 mt-24 pb-12">
            ...
            <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                ...
                <div class="sm:col-span-2 sm:col-start-1">
                <label for="distrito" class="block text-sm font-medium leading-6 text-marron-800">Distrito</label>
                <div class="mt-2">
                    <input required type="text" name="distrito" id="distrito" autocomplete="off" class="block w-full rounded-md border-0 py-1.5 text-gris-900 shadow-sm ring-1 ring-inset ring-gris-300 placeholder:text-gris-400 focus:ring-2 focus:ring-inset focus:ring-marron-600 sm:text-sm sm:leading-6">
                </div>
                </div>
                ...
                <div class="mt-2">
                    <input required pattern="[0-9]+" type="text" name="numero" id="numero" autocomplete="off" class="block w-full rounded-md border-0 py-1.5 text-gris-900 shadow-sm ring-1 ring-inset ring-gris-300 placeholder:text-gris-400 focus:ring-2 focus:ring-inset focus:ring-marron-600 sm:text-sm sm:leading-6">
                </div>
                </div>
