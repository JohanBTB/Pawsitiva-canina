    ...
    <div class="relative mx-auto max-w-4xl  py-12 md:py-24 xl:py-32  max-w-screen-md">
        <form class=" sm:mb-24 mb-32">   
            ...
            <div class="relative">
                ...
                <input type="text" id="search" name="search" class="block w-full p-4 pl-10 text-sm text-gris-900 border border-marron-600 rounded-lg bg-gray-50 focus:ring-marron-800 focus:border-marron-300 " placeholder="Usuarios, perritos, albergues ..." required>
