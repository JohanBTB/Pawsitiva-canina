...
<div class="flex flex-col col-span-1 relative overflow-hidden rounded-lg shadow-lg  items-center py-10 text-marron-600" >
        ...
        <div class="w-full px-4 lg:order-2 flex justify-center">
            <img class="w-24 h-24 mb-3 rounded-full shadow-lg" src="images/buscar/{{ $dato['foto']}}" alt="{{ $dato['nombre'] }}"/>
        </div>
        <div class="w-full px-4 lg:order-2 flex justify-center">
        ...
        <div class="flex  mt-4 space-x-3 md:mt-6">
            ...
            @if($dato['adoptado_por'])
                ...
                @else
                <a href="#" class="inline-flex items-center px-4 py-2 text-sm font-medium text-center text-white bg-marron-700 rounded-lg hover:bg-marron-800 focus:ring-4 focus:outline-none focus:ring-marron-300">
                Adoptar amiguito
                 @endif </a>
            @else
